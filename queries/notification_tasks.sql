-- Notification task retry queue. All full-row queries share the
-- `NotificationTaskRow` type so the repo layer needs a single
-- `From<NotificationTaskRow> for models::NotificationTask`.
