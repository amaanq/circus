-- Starred job CRUD for the personalized dashboard. All full-row queries share
-- the `StarredJobRow` type so the repo layer needs a single
-- `From<StarredJobRow> for models::StarredJob`.
