-- Webhook config CRUD. All full-row queries share the `WebhookConfigRow` type
-- so the repo layer needs a single `From<WebhookConfigRow> for models::WebhookConfig`.
