-- Remote builder CRUD. All full-row queries share the `RemoteBuilderRow` type so
-- the repo layer needs a single `From<RemoteBuilderRow> for models::RemoteBuilder`.
