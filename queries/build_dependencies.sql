-- Build dependency relationships. Full `build_dependencies` rows share the
-- `BuildDependencyRow` type; queries returning full `builds` rows share the
-- `BuildRow` type so the repo layer maps each to a single model.
--: BuildDependencyRow()
