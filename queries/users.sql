-- User CRUD, authentication, and session management. All full-row `users`
-- queries share the `UserRow` type so the repo layer needs a single
-- `From<UserRow> for models::User`.
